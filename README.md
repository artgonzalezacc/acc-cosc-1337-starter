...
run="export CC=clang; export CXX=clang++; rm -rf ../build; mkdir -p ../build; cd ../build; cmake ../acc-cosc-1337-spring-2021-yourusername/; 
make; cd src/examples/01_module; ./ex_01_01_exe"
...
cd src/examples/01_module; <-- this statement tells the operating system to change to the 01_module folder
